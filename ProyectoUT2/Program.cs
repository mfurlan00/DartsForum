...
namespace DartsForum
{
    class Program
    {
        ...
        //Lista de listas en eventos
        static ArrayList Events = BuildEvents();

        //Lista de listas en perfiles
        static ArrayList Profiles = BuildProfiles();

        //Lista de listas en pedidos
        ...
        static ArrayList BuildPlacesMadrid()
        {
            ...
            Add(3, "Pool Madrid Club","Centro, Madrid", "18:00 - 02:00");
        ...
        static void CreateUser()
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    break; // sale del while cuando las contraseñas coinciden
                }
        ...
        static void ShowOthers()
        {
            ...
            Console.WriteLine("|Ref.  | Marca    | Modelo                                | Precio  |");
            Console.WriteLine("|------|----------|---------------------------------------|---------|");
            Console.WriteLine("|OT001 | Winmau   | Diana electronica                     | 139.99  |");
            Console.WriteLine("|------|----------|---------------------------------------|---------|");
            Console.WriteLine("|OT002 | Winmau   | Pack ahorro professional darts        | 39.99   |");
            Console.WriteLine("|------|----------|---------------------------------------|---------|");
            Console.WriteLine("|OT003 | Winmau   | Kit accesorios #01                    | 29.99   |");
            Console.WriteLine("|------|----------|---------------------------------------|---------|");
            Console.WriteLine("|OT004 | Winmau   | Diana electronica LsL                 | 169.99  |");
            Console.WriteLine("|------|----------|---------------------------------------|---------|");
            Console.WriteLine("|OT005 | Winmau   | Diana electronica Pro S               | 199.99  |");
            Console.WriteLine("|------|----------|---------------------------------------|---------|");
            Console.WriteLine("|OT006 | Winmau   | Diana electronica Pro M               | 239.99  |");
            Console.WriteLine("|------|----------|---------------------------------------|---------|");
            Console.WriteLine("|OT007 | Winmau   | Diana electronica Pro L               | 269.99  |");
            Console.WriteLine("|------|----------|---------------------------------------|---------|");
            Console.WriteLine("|OT008 | Winmau   | Pack dardos mid + kit accesorios      | 39.99   |");
            Console.WriteLine("---------------------------------------------------------------------");
        }
        ...
        static void WhereToPlay()
        {
            ...
            {
                if (!Char.IsDigit(c)) //AÑADIDO EXTRA Verifica que el input no es un numero
                {
                    isNumber = false;
